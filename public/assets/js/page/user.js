...
(() => {
        ...
        Api.User.GetOne(id)
            .done(res => {
                ...
                View.modals.UpdateUser.onPush("Save", () => {
                    View.helper.showToastProcessing('Processing', 'Update status !');
                    Api.User.UpdateStatus(id, View.modals.UpdateUser.getVal())
                        .done(res => {
                            View.helper.showToastSuccess('Success', 'Update successful'); 
    ...
    function LoadData(){
        ...
        Api.User.GetAll(View.table.pagination.page, View.table.pagination.pageSize, filter)
            .done(res => {
                console.log(res);
                loadOrders(res); 
            });
