...
router.put('/serial/updateLink/:id', isAuth.validateToken, serialController.updateLink);
...
router.get('/nft/tokendetail', isAuth.validateToken, nftController.getTokenFromDB);
...
router.get('/nft/select-serials', isAuth.validateMarketToken, nftController.selectSerials);
